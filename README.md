...
- 랜덤 주문번호(100~999) 발급, 5초 후 자동 처음 화면
...
![주문 완료](docs/screenshots/ko-10-complete.png)

- **결제가 완료되었습니다** + 주문번호
- 주문 방식 · 결제 수단 · 금액 · 영수증 여부 요약
- 5초 후 자동 처음 화면, **처음으로** 즉시 이동
